export const getFeetAndInchesWithFraction = (value: number): { feet: number; inches: number; fraction: string } => {
    ...
    if (eighths > 0 && eighths < 8) {
        ...
        switch(eighths) {
            ...
            case 2: fraction = '¼'; break;
            case 3: fraction = '⅜'; break;
            case 4: fraction = '½'; break;
            case 5: fraction = '⅝'; break;
            case 6: fraction = '¾'; break;
