...
const AccessPointList: React.FC<AccessPointListProps> = ({ currentElevation }) => {
    ...
    const openAccessPoints = accessPoints.filter(ap =>
    ...
    return (
        <div className="access-point-list">
            <div className="access-point-list-header">
                <h2 className="access-point-list-title">Ramps & Channels</h2>
            ...
            <div className="access-point-items">
                {!accessPoints.length ? <div className="no-access-points">No access points available in this region</div> :
